...
const Navigation = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesQrl(/* @__PURE__ */ inlinedQrl(css$3, "Navigation_component_useStyles_IifmPGQx018"));
...
const WeekDay = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesQrl(/* @__PURE__ */ inlinedQrl(css$1, "WeekDay_component_useStyles_3vNhaKsSX1M"));
...
const Day = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesQrl(/* @__PURE__ */ inlinedQrl(css, "Day_component_useStyles_ak21olthqc0"));
  const thisDate = new Date(props.dateObj.valueOf());
  const today = /* @__PURE__ */ new Date();
  const textColor = thisDate.getDay() === 0 || thisDate.getDay() === 6 ? "#d10000" : "#000000";
  const bgColor = Math.round(props.dateObj / 864e5) === Math.round(today.valueOf() / 864e5) ? "#FFFF76" : "transparent";
...
const Days = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  ...
  for (let i = 0; i < lens; i++) {
    daysOfTheMonth.push(/* @__PURE__ */ _jsxC(Day, {
...
const MonthView = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesQrl(/* @__PURE__ */ inlinedQrl(css$2, "MonthView_component_useStyles_4hMoRvpsKY4"));
  return /* @__PURE__ */ _jsxC(Fragment, {
    children: /* @__PURE__ */ _jsxQ("div", null, {
...
const Calendar = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesQrl(/* @__PURE__ */ inlinedQrl(css$4, "Calendar_component_useStyles_RySDPue42WQ"));
