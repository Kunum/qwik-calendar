...
const Navigation = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesQrl(/* @__PURE__ */ inlinedQrl(css$6, "Navigation_component_useStyles_IifmPGQx018"));
  ...
  if (props.view === "month")
    return /* @__PURE__ */ _jsxC(Fragment, {
      children: /* @__PURE__ */ _jsxQ("div", null, {
        ...
        /* @__PURE__ */ _jsxQ("button", null, {
          ...
          style: _fnSignal((p0) => p0.buttonStyles, [
            props
          ], "p0.buttonStyles")
        }, "«", 3, null),
        /* @__PURE__ */ _jsxQ("button", null, {
    ...
    return /* @__PURE__ */ _jsxC(Fragment, {
      children: /* @__PURE__ */ _jsxQ("div", null, {
        ...
        }, /* @__PURE__ */ _jsxQ("span", null, null, calculateCentury(year.value), 1, null), 1, null),
        /* @__PURE__ */ _jsxQ("button", null, {
          onClick$: /* @__PURE__ */ inlinedQrl(() => {
            const [props2, year2] = useLexicalScope();
            const newDate = new Date(props2.dateObj);
  ...
  return /* @__PURE__ */ _jsxC(Fragment, null, 3, "OK_4");
...
const WeekDay = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesQrl(/* @__PURE__ */ inlinedQrl(css$4, "WeekDay_component_useStyles_3vNhaKsSX1M"));
...
const Day = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesQrl(/* @__PURE__ */ inlinedQrl(css$3, "Day_component_useStyles_ak21olthqc0"));
...
const MonthView = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesQrl(/* @__PURE__ */ inlinedQrl(css$5, "MonthView_component_useStyles_4hMoRvpsKY4"));
  return /* @__PURE__ */ _jsxC(Fragment, {
    children: /* @__PURE__ */ _jsxQ("div", null, {
...
const YearView = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  _jsxBranch();
  useStylesQrl(/* @__PURE__ */ inlinedQrl(css$2, "YearView_component_useStyles_Z0WZ7F85LDg"));
  const months = [];
...
const DecadeView = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  _jsxBranch();
  useStylesQrl(/* @__PURE__ */ inlinedQrl(css$1, "DecadeView_component_useStyles_VM7XN0t0pnY"));
  const baseDate = new Date(props.dateObj);
...
const Decade = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  const thisDate = new Date(props.dateObj);
  const currentDate = /* @__PURE__ */ new Date();
  ...
  return /* @__PURE__ */ _jsxQ("button", {
    ...
    "qc-comp-id": "tile"
  }, /* @__PURE__ */ _jsxC(Slot, null, 3, "FZ_0"), 0, "FZ_1");
}, "Decade_component_DEHCrzDlwjg"));
const CenturyView = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  _jsxBranch();
  useStylesQrl(/* @__PURE__ */ inlinedQrl(css, "CenturyView_component_useStyles_lsMOoOcNWEY"));
  const baseDate = new Date(props.dateObj);
  ...
  for (let ano = firstYearOfTheCentury; ano <= firstYearOfTheCentury + 99; ano += 10) {
    baseDate.setFullYear(ano);
    anos.push(/* @__PURE__ */ _jsxC(Decade, {
      dateObj: baseDate.valueOf(),
      get styles() {
      ...
      [_IMMUTABLE]: {
        ...
        styles: _fnSignal((p0) => p0.decadeStyles, [
          props
        ], "p0.decadeStyles")
      }
    }, 0, ano));
...
const Calendar = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  _jsxBranch();
  useStylesQrl(/* @__PURE__ */ inlinedQrl(css$7, "Calendar_component_useStyles_RySDPue42WQ"));
  ...
  if (currentView.value === "month")
    ...
    view = /* @__PURE__ */ _jsxC(CenturyView, {
      get dateObj() {
        return currentDate.value;
      },
      onChangeCurrentDate$,
      ...
      [_IMMUTABLE]: {
        ...
        decadeStyles: _fnSignal((p0) => p0.decadeStyles, [
          props
        ], "p0.decadeStyles"),
        onChangeCurrentDate$: _IMMUTABLE,
        onChangeCurrentView$: _IMMUTABLE,
        styles: _fnSignal((p0) => p0.centuryViewStylse, [
          props
  ...
  return /* @__PURE__ */ _jsxC(Fragment, {
    children: /* @__PURE__ */ _jsxQ("div", null, {
      ...
      props.hideNavigation ? /* @__PURE__ */ _jsxC(Fragment, null, 3, "w3_4") : /* @__PURE__ */ _jsxC(Navigation, {
        locale,
        get dateObj() {
          return currentDate.value;
        },
        ...
        [_IMMUTABLE]: {
          buttonStyles: _fnSignal((p0) => p0.navigationButtonStyles, [
            props
