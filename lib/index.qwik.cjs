...
const Navigation = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  ...
  return /* @__PURE__ */ qwik._jsxC(jsxRuntime.Fragment, null, 3, "OK_2");
}, "Navigation_component_ts5VFnLi8bQ"));
const css$3 = ":where([qc-comp-id='monthview']){\r\n    flex-grow: 1;\r\n    text-align: center;\r\n    text-transform: uppercase;\r\n    font-weight: bold;\r\n    font-size: 0.75em;\r\n}";
const css$2 = ":where([qc-comp-id='weekdays']){\r\n    display: flex;\r\n    flex-wrap: nowrap;\r\n}\r\n\r\n:where([qc-comp-id='weekday']){\r\n    flex: 0 0 14.2857%;\r\n    overflow: hidden;\r\n    margin-inline-end: 0px;\r\n    padding: 0.5em;\r\n}";
const weekdays = {
  "pt-br": [
    "Domingo",
    "Segunda",
...
const WeekDay = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesQrl(/* @__PURE__ */ qwik.inlinedQrl(css$2, "WeekDay_component_useStyles_3vNhaKsSX1M"));
...
const MonthView = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesQrl(/* @__PURE__ */ qwik.inlinedQrl(css$3, "MonthView_component_useStyles_4hMoRvpsKY4"));
  return /* @__PURE__ */ qwik._jsxC(jsxRuntime.Fragment, {
    children: /* @__PURE__ */ qwik._jsxQ("div", null, {
...
const css = ":where([qc-comp-id='month-tile']){\r\n    padding: 2em 0.5em;\r\n}\r\n";
...
const YearView = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik._jsxBranch();
  qwik.useStylesQrl(/* @__PURE__ */ qwik.inlinedQrl(css, "YearView_component_useStyles_Z0WZ7F85LDg"));
  const months = [];
...
const Calendar = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik._jsxBranch();
  qwik.useStylesQrl(/* @__PURE__ */ qwik.inlinedQrl(css$5, "Calendar_component_useStyles_RySDPue42WQ"));
  ...
  return /* @__PURE__ */ qwik._jsxC(jsxRuntime.Fragment, {
    children: /* @__PURE__ */ qwik._jsxQ("div", null, {
      ...
      props.hideNavigation ? /* @__PURE__ */ qwik._jsxC(jsxRuntime.Fragment, null, 3, "w3_2") : /* @__PURE__ */ qwik._jsxC(Navigation, {
        locale,
        get dateObj() {
          return currentDate.value;
        },
