...
const Navigation = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesQrl(/* @__PURE__ */ qwik.inlinedQrl(css$5, "Navigation_component_useStyles_IifmPGQx018"));
  ...
  return /* @__PURE__ */ qwik._jsxC(jsxRuntime.Fragment, null, 3, "OK_3");
...
const WeekDay = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesQrl(/* @__PURE__ */ qwik.inlinedQrl(css$3, "WeekDay_component_useStyles_3vNhaKsSX1M"));
...
const Day = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesQrl(/* @__PURE__ */ qwik.inlinedQrl(css$2, "Day_component_useStyles_ak21olthqc0"));
...
const MonthView = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesQrl(/* @__PURE__ */ qwik.inlinedQrl(css$4, "MonthView_component_useStyles_4hMoRvpsKY4"));
  return /* @__PURE__ */ qwik._jsxC(jsxRuntime.Fragment, {
    children: /* @__PURE__ */ qwik._jsxQ("div", null, {
...
const YearView = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik._jsxBranch();
  qwik.useStylesQrl(/* @__PURE__ */ qwik.inlinedQrl(css$1, "YearView_component_useStyles_Z0WZ7F85LDg"));
  const months = [];
...
const DecadeView = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik._jsxBranch();
  qwik.useStylesQrl(/* @__PURE__ */ qwik.inlinedQrl(css, "DecadeView_component_useStyles_VM7XN0t0pnY"));
  const baseDate = new Date(props.dateObj);
...
const Calendar = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik._jsxBranch();
  qwik.useStylesQrl(/* @__PURE__ */ qwik.inlinedQrl(css$6, "Calendar_component_useStyles_RySDPue42WQ"));
  ...
  return /* @__PURE__ */ qwik._jsxC(jsxRuntime.Fragment, {
    children: /* @__PURE__ */ qwik._jsxQ("div", null, {
      ...
      props.hideNavigation ? /* @__PURE__ */ qwik._jsxC(jsxRuntime.Fragment, null, 3, "w3_3") : /* @__PURE__ */ qwik._jsxC(Navigation, {
        locale,
        get dateObj() {
          return currentDate.value;
        },
